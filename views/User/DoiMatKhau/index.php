 ...
 if(  isset($_SESSION['change_success']) && $_SESSION['change_success'] == 1 )
    ...
    elseif(  isset($_SESSION['password_mismatch']) && $_SESSION['password_mismatch'] == -1 ) 
    {
     echo "<div class='alert alert-warning'>
          <strong>Alert!</strong> Password missing...
    </div>";unset($_SESSION['password_mismatch']); 
    }

    elseif(  isset($_SESSION['password_mismatch']) && $_SESSION['password_mismatch'] == -2 ) 
    {
     echo "<div class='alert alert-warning'>
...
?>
    ...
    <form action="process.php" method="POST" class="form-horizontal col-sm-offset-4" role="form">
        <div class="form-group">
          <legend >Change Password</legend>

        </div>
        <input type="hidden" class="form-control" name="username" id="username" value="<?=$_SESSION['MaNV']?>">
