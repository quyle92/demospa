...
<?php require_once('./mvc/views/pages/datetimepicker_bymonth.php'); ?> 
</form> 
...
<?php
$clientRevByMonth = $data['doanhThuThang'];
...
$('form#monthSelected').on('submit', function (event){
    ...
    $.ajax({
      url:"../doanhthu-khachle-khachthe/ajax-call/process-month.php",
      method:"POST",
      data:formValues,
      dataType:"json",
