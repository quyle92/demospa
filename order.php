	...
	try
	{
		...
		if(($rs) != false)
		{
			foreach($rs as $r1)
			{
				...
				{
?>		
					<button type="submit" name="manhomhangban" value="<?php echo $r1['Ma']; ?>" class="nhomhb_active"><?php echo utf8_encode($r1['Ten']); ?></button>
<?php
				}
				else
				{
?>				
					<button type="submit" name="manhomhangban" value="<?php echo $r1['Ma']; ?>" class="nhomhb"><?php echo utf8_encode($r1['Ten']); ?></button>
<?php
				}
			}
...
<!-----------------------------SHIPPING METHOD ---------------------------->
<?php require('order/tab_client_card.php'); ?>
