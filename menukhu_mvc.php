...
?>
            ...
            <li style="list-style-type: none;" class="li-level1">
                <a class="menu-level1" href="<?=( isset($_SERVER['HTTPS']) ? "https://" : "http://" ) . $_SERVER['HTTP_HOST']  . ( ( $_SERVER['SERVER_NAME'] !== 'localhost' ) ? "" : "/demospa" ) . '/Users/Logout/' ?>"><i class="fa fa-sign-out nav_icon"></i>THOÁT</a>
            </li>
        </div>
    </div>
</nav>