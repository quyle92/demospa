...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <h1>HÌNH KH <?php echo $makhmoi;?></h1>
    <form action="orderKH_update.php" method="post" >
      <p><input type="hidden" name="makh" value="<?php echo @$makhmoi; ?>" style="width:100%;">
      </p>
      <img src="images/KH/<?php echo $tenhinh.".jpg";?>" width="400" height="500" style="margin: auto;">
